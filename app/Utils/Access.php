...
class Access {
    public static function cleanHost(): void {
        ...
        $host = \Wolf\Utils\Variables::getHostWithProtocol();
    ...
    public static function getCurrentOperatorId(): ?int {
        return \Wolf\Utils\Routes::getCurrentRequestOperator()?->id;
    }

    public static function getCurrentOperatorApiKeyId(): ?int {
        return \Wolf\Utils\Routes::getCurrentRequestApiKey()?->id;
    }

    public static function hashPassword(string $password): string {
        $pepper = \Wolf\Utils\Variables::getPepper();
