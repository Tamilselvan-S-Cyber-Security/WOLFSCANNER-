...
class Constants {
    ...
    protected string $PAGE_TITLE_POSTFIX = '| Wolf Security scanner';
    ...
    protected array $CHART_MODEL_MAP = [
        'resources'         => \Wolf\Models\Chart\Resources::class,
        'resource'          => \Wolf\Models\Chart\Resource::class,
        'users'             => \Wolf\Models\Chart\Users::class,
        'user'              => \Wolf\Models\Chart\User::class,
        'isps'              => \Wolf\Models\Chart\Isps::class,
        'isp'               => \Wolf\Models\Chart\Isp::class,
        'ips'               => \Wolf\Models\Chart\Ips::class,
        'ip'                => \Wolf\Models\Chart\Ip::class,
        'domains'           => \Wolf\Models\Chart\Domains::class,
        'domain'            => \Wolf\Models\Chart\Domain::class,
        'userAgents'        => \Wolf\Models\Chart\UserAgents::class,
        'userAgent'         => \Wolf\Models\Chart\UserAgent::class,
        'events'            => \Wolf\Models\Chart\Events::class,
        'emails'            => \Wolf\Models\Chart\Emails::class,
        'phones'            => \Wolf\Models\Chart\Phones::class,
        'review-queue'      => \Wolf\Models\Chart\ReviewQueue::class,
        'country'           => \Wolf\Models\Chart\Country::class,
        'blacklist'         => \Wolf\Models\Chart\Blacklist::class,
        'logbook'           => \Wolf\Models\Chart\Logbook::class,
        'stats'             => \Wolf\Models\Chart\SessionStat::class,
        'fields'            => \Wolf\Models\Chart\FieldAuditTrails::class,
        'field'             => \Wolf\Models\Chart\FieldAuditTrail::class,
        'risk-correlation'  => \Wolf\Models\Chart\RiskCorrelation::class,
    ];
    ...
    protected array $TOP_TEN_MODELS_MAP = [
        'mostActiveUsers'           => \Wolf\Models\TopTen\UsersByEvents::class,
        'mostActiveCountries'       => \Wolf\Models\TopTen\CountriesByUsers::class,
        'mostActiveUrls'            => \Wolf\Models\TopTen\ResourcesByUsers::class,
        'ipsWithTheMostUsers'       => \Wolf\Models\TopTen\IpsByUsers::class,
        'usersWithMostLoginFail'    => \Wolf\Models\TopTen\UsersByLoginFail::class,
        'usersWithMostIps'          => \Wolf\Models\TopTen\UsersByIps::class,
    ];

    protected array $RULES_TOTALS_MODELS = [
        \Wolf\Models\Phone::class,
        \Wolf\Models\Ip::class,
        \Wolf\Models\Session::class,
        \Wolf\Models\User::class,
    ];

    protected array $REST_TOTALS_MODELS = [
        'isp'       => \Wolf\Models\Isp::class,
        'resource'  => \Wolf\Models\Resource::class,
        'domain'    => \Wolf\Models\Domain::class,
        'device'    => \Wolf\Models\Device::class,
        'country'   => \Wolf\Models\Country::class,
        'field'     => \Wolf\Models\FieldAudit::class,
    ];

    protected array $ENRICHING_ATTRIBUTES = [
        'ip'        => \Wolf\Models\Ip::class,
        'email'     => \Wolf\Models\Email::class,
        'domain'    => \Wolf\Models\Domain::class,
        'phone'     => \Wolf\Models\Phone::class,
        //'ua'        => \Wolf\Models\Device::class,
    ];
    ...
    protected array $ADMIN_PAGES = [
        ...
        'AdminFieldAudits',
        'AdminFieldAudit',
        'AdminRiskCorrelation',
        'AdminCyberChat',
        'AdminPhishingDetector',
    ];
