...
class Event extends \Wolf\Models\BaseSql {
    ...
    public function getEventDetails(int $id, int $apiKey): array {
        ...
        $query = (
            ...
            LEFT JOIN countries AS ip_countries
        ...
        \Wolf\Utils\Enrichment::calculateIpType($results);
        \Wolf\Utils\Enrichment::calculateEmailReputation($results);
