...
abstract class BaseEventsCount extends \Wolf\Models\BaseSql {
    ...
    public function __construct() {
        ...
        [$this->alertTypesParams, $this->alertFlatIds]      = $this->getArrayPlaceholders(\Wolf\Utils\Constants::get()->ALERT_EVENT_TYPES, 'alert');
        [$this->editTypesParams, $this->editFlatIds]        = $this->getArrayPlaceholders(\Wolf\Utils\Constants::get()->EDITING_EVENT_TYPES, 'edit');
        [$this->normalTypesParams, $this->normalFlatIds]    = $this->getArrayPlaceholders(\Wolf\Utils\Constants::get()->NORMAL_EVENT_TYPES, 'normal');
    }
    ...
    public function getData(int $apiKey): array {
        ...
        $offset = \Wolf\Utils\Timezones::getCurrentOperatorOffset();
        $datesRange = \Wolf\Utils\DateRange::getLatestNDatesRangeFromRequest(180, $offset);
        $endTs = strtotime($datesRange['endDate']);
        $startTs = strtotime($datesRange['startDate']);
        $step = \Wolf\Utils\Constants::get()->CHART_RESOLUTION[\Wolf\Utils\DateRange::getResolutionFromRequest()];
    ...
    protected function executeOnRangeById(string $query, int $apiKey): array {
        ...
        $dateRange = \Wolf\Utils\DateRange::getLatestNDatesRangeFromRequest(180);
        $offset = \Wolf\Utils\Timezones::getCurrentOperatorOffset();
        ...
        $params = [
            ...
            ':resolution'   => \Wolf\Utils\DateRange::getResolutionFromRequest(),
            ':id'           => \Wolf\Utils\Conversion::getIntRequestParam('id'),
