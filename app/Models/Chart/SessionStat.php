...
class SessionStat extends Base {
    ...
    public function getData(int $apiKey): array {
        ...
        $datesRange = \Wolf\Utils\DateRange::getLatestNDatesRangeFromRequest(14, $offset);
    ...
    protected function executeOnRangeById(string $query, int $apiKey): array {
        ...
        $dateRange = \Wolf\Utils\DateRange::getLatestNDatesRangeFromRequest(14);
        $offset = \Wolf\Utils\Timezones::getCurrentOperatorOffset();
        ...
        $params = [
            ...
            ':resolution'   => \Wolf\Utils\Constants::get()->SECONDS_IN_DAY,
