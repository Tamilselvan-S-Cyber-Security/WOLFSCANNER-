...
class Users extends Base {
    ...
    private function getFirstLine(int $apiKey): array {
        ...
        $params = [
            ...
            ':high_inf'     => \Wolf\Utils\Constants::get()->USER_HIGH_SCORE_INF,
            //':high_sup'     => \Wolf\Utils\Constants::get()->USER_HIGH_SCORE_SUP,
            ':med_inf'      => \Wolf\Utils\Constants::get()->USER_MEDIUM_SCORE_INF,
            ':med_sup'      => \Wolf\Utils\Constants::get()->USER_MEDIUM_SCORE_SUP,
            ':low_inf'      => \Wolf\Utils\Constants::get()->USER_LOW_SCORE_INF,
            ':low_sup'      => \Wolf\Utils\Constants::get()->USER_LOW_SCORE_SUP,
        ];
