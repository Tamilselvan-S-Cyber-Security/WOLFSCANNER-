...
class NotificationPreferences extends \Wolf\Models\BaseSql {
    protected ?string $DB_TABLE_NAME = 'dshb_operators';

    public function operatorsToNotify(): array {
        $params = [
            ':daily'    => \Wolf\Utils\Constants::get()->DAILY_NOTIFICATION_REMINDER,
            ':weekly'   => \Wolf\Utils\Constants::get()->WEEKLY_NOTIFICATION_REMINDER,
            ':off'      => \Wolf\Utils\Constants::get()->NO_NOTIFICATION_REMINDER,
        ];
