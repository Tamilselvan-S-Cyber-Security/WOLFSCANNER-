...
class Country extends \Wolf\Models\BaseSql implements \Wolf\Interfaces\ApiKeyAccessAuthorizationInterface {
    ...
    public function getCountryIdByIso(string $countryIso): int {
        ...
        $query = (
            ...
            WHERE
               UPPER(TRIM(countries.iso)) = UPPER(:country_iso)'
        );
