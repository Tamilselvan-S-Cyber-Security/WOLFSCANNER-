...
class User extends \Wolf\Models\BaseSql implements \Wolf\Interfaces\ApiKeyAccessAuthorizationInterface, \Wolf\Interfaces\ApiKeyAccountAccessAuthorizationInterface {
    ...
    public function getApplicableRulesByAccountId(int $id, int $apiKey, bool $all = false): array {
        ...
        usort($results, [\Wolf\Utils\Sort::class, 'cmpScore']);
