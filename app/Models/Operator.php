...
class Operator extends \Wolf\Models\BaseSql {
    ...
    public function insertRecord(?string $password, string $email, string $timezone): int {
        $params = [
            ':password' => $password ? \Wolf\Utils\Access::hashPassword($password) : $password,
            ':email'    => $email,
            ':timezone' => $timezone,
            ':active'   => 1,
        ];
    ...
    public function updatePassword(string $password, int $operatorId): void {
        $params = [
            ':password'     => \Wolf\Utils\Access::hashPassword($password),
    ...
    public function verifyPassword(string $password, int $operatorId): bool {
        ...
        return \Wolf\Utils\Access::verifyPassword($password, $operatorPassword);
    }
