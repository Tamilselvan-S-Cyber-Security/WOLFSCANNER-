...
namespace Wolf\Controllers\Api;
...
abstract class Endpoint {
    ...
    protected \Wolf\Views\Json $response;
    ...
    //protected \Wolf\Interfaces\ApiKeyAccessAuthorizationInterface $authorizationModel;
    ...
    public function __construct() {
        ...
        \Wolf\Utils\Database::initConnect(false);

        $this->response = new \Wolf\Views\Json();
        $this->responseType = \Wolf\Utils\Constants::get()->SINGLE_RESPONSE_TYPE;
    }
    ...
    protected function identify(): void {
        ...
        $this->setError(400, \Wolf\Utils\ErrorCodes::REST_API_KEY_DOES_NOT_EXIST);
    }
    ...
    protected function authenticate(): void {
        ...
        $this->setError(401, \Wolf\Utils\ErrorCodes::REST_API_KEY_IS_NOT_CORRECT);
    }
    ...
    /*protected function authorize(string $subjectId): void {
        ...
        $this->setError(403, \Wolf\Utils\ErrorCodes::REST_API_NOT_AUTHORIZED);
    }*/
    ...
    protected function saveLogbook(): void {
        ...
        $model->add(
            ...
            $this->f3->get('PATH'),
            null,
            !isset($this->error) ? \Wolf\Utils\Constants::get()->LOGBOOK_ERROR_TYPE_SUCCESS : \Wolf\Utils\Constants::get()->LOGBOOK_ERROR_TYPE_CRITICAL_ERROR,
    ...
    private function handleInternalServerError(): void {
        $errorData = \Wolf\Utils\ErrorHandler::getErrorDetails($this->f3);
        \Wolf\Utils\ErrorHandler::saveErrorInformation($this->f3, $errorData);
