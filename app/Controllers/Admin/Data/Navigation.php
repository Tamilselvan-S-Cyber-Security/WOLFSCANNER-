...
class Navigation extends \Wolf\Controllers\Admin\Base\Navigation {
    private \Wolf\Controllers\Admin\Data\Data $dataController;
    ...
    public function getReportSenderCount(): void {
        $this->response->data = $this->dataController->getReportSenderCount();
    }

    public function reportSenderIncrement(): void {
        $this->response->data = $this->dataController->reportSenderIncrement();
    }

    public function getOllamaStatus(): void {
        $this->response->data = $this->dataController->getOllamaStatus();
    }

    public function checkPhish(): void {
        $this->response->data = $this->dataController->checkPhish();
    }

    public function apiTesterRequest(): void {
        $this->response->data = $this->dataController->apiTesterRequest();
    }
}
