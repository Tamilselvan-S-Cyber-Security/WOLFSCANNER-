<?php if (isset($showChart) && 1 === $showChart): ?>
    <div class="main-graph separate-graph">
        <?php if (false !== strpos($CURRENT_PATH, 'id')): ?>
...
" ?>
            <span>&#8943;</span><p class="tooltip-info tooltip" title="<?= ($AdminUsers_table_title_tooltip) ?>"><?php echo $this->render('images/icons/information.svg',NULL,get_defined_vars(),0); ?></p>
        </div>
    </header>
    ...
    <div class="card-table">
        <div class="content">
            <?php if (false !== strpos($CURRENT_PATH, 'id')): ?>
                    ...
                    <?php echo $this->render('templates/parts/choices/scoresRange.html',NULL,get_defined_vars(),0); ?>
