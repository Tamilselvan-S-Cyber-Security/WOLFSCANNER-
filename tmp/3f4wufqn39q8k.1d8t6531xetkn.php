...
" ?>
            <span>&#8943;</span><p class="tooltip-info tooltip" title="<?= ($AdminDevices_table_title_tooltip) ?>"><?php echo $this->render('images/icons/information.svg',NULL,get_defined_vars(),0); ?>
            </p>
        </div>
    </header>
